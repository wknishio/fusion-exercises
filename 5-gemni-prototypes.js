...
google.maps.InfoWindow.prototype.setContactValue = function(contact)
{
	this.contact = contact;
}

google.maps.InfoWindow.prototype.getContactValue = function()
{
	return this.contact;
}

google.maps.InfoWindow.prototype.setAccessValue = function(access)
{
	this.access = access;
}

google.maps.InfoWindow.prototype.getAccessValue = function()
{
	return this.access;
}

google.maps.InfoWindow.prototype.setCostValue = function(cost)
{
	this.cost = cost;
}

google.maps.InfoWindow.prototype.getCostValue = function()
{
	return this.cost;
}

google.maps.InfoWindow.prototype.setDayPeriodsValue = function(dayperiods)
{
	this.dayperiods = dayperiods;
}

google.maps.InfoWindow.prototype.getDayPeriodsValue = function()
{
	return this.dayperiods;
}

google.maps.InfoWindow.prototype.setWeekDaysValue = function(weekdays)
{
	this.weekdays = weekdays;
}

google.maps.InfoWindow.prototype.getWeekDaysValue = function()
{
	return this.weekdays;
}

google.maps.InfoWindow.prototype.setModalitiesValue = function(modalities)
{
	this.modalities = modalities;
}

google.maps.InfoWindow.prototype.getModalitiesValue = function()
{
